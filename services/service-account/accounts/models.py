...
class AccountDetail(models.Model):
    ...
    account_type = models.ForeignKey(AccountType, on_delete=models.PROTECT, related_name='account_details')
...
class DeletedAccount(models.Model):
    account = models.ForeignKey(Account, on_delete=models.CASCADE, related_name='deleted_records')
    timestamp = models.DateTimeField(auto_now_add=True)
