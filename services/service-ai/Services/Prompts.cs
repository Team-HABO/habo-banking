...
public static class Prompts
{
    public const string FraudDetection =
        ...
        - "reason": string (Explicitly state which heuristic was triggered and include the specific value that caused it, e.g. "Amount of 15,000 exceeds the 10,000 threshold" or "Origin IP resolves to Nigeria, a high-risk country". If no heuristic is triggered, return "Clear".)
